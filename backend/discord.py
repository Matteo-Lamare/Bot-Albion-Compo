...
async def envoyer_webhook(
    ...
    Le webhook Discord utilise par ce bot cible un Forum Channel. Le type forum
    est donc le comportement par defaut afin qu'un appelant qui ne precise pas
    le type n'envoie jamais une requete invalide sans thread_name.
    """
    if not url:
