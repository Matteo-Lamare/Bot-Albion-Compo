...
class Compo(Base):
    ...
    # Trace des messages postes sur Discord, au format JSON : identifiant du
    # message et builds qu'il presente.
...
class LigneCompo(Base):
    ...
    # Facultatif : une ligne est d'abord un build. Vide, elle s'affiche « Build #n ».
